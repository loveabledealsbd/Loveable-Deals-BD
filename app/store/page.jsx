...
import { fetchOrdersByStoreId } from "@/lib/firestore/orders"
import { fetchRatingsByStoreId } from "@/lib/firestore/ratings"
    ...
    const fetchDashboardData = async () => {
        ...
        try {
            ...
            const [products, orders, ratings] = await Promise.all([
                fetchProductsByStoreId(store.id),
                fetchOrdersByStoreId(store.id),
                fetchRatingsByStoreId(store.id),
            ])
                            ...
                            <div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-light text-slate-500">{review.createdAt ? new Date(review.createdAt.seconds ? review.createdAt.seconds * 1000 : review.createdAt).toDateString() : ''}</p>
                                    </div>
                                </div>
