...
const RatingModal = ({ ratingModal, setRatingModal }) => {
    ...
    const handleSubmit = async () => {
        ...
        if (!user?.uid) {
            return toast.error('Please login to submit a rating');
        }
        ...
        const docId = await addRatingToFirestore(ratingData);
        dispatch(addRating({ id: docId, ...ratingData, createdAt: new Date().toISOString() }));
