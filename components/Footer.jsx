...
const Footer = () => {
    ...
    const TiktokIcon = () => (<svg width="20" height="20"
    viewBox="0 0 24 24"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
    <path
      d="M16.5 3C16.8 5 18.3 6.6 20.3 7V10C18.7 10 17.2 9.5 16 8.6V14.5C16 18 13.2 21 9.5 21C6.5 21 4 18.5 4 15.5C4 12.5 6.5 10 9.5 10C9.9 10 10.3 10 10.7 10.1V13C10.3 12.8 9.9 12.7 9.5 12.7C8 12.7 6.8 13.9 6.8 15.4C6.8 16.9 8 18.1 9.5 18.1C11.1 18.1 12.2 16.9 12.2 15.3V3H16.5Z"
      stroke="#90A1B9"
      strokeWidth="1.5"
      strokeLinecap="round"
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+880 1575380707", path: '/', icon: PhoneIcon },
                { text: "loveabledealsbd@gmail.com", path: '/', icon: MailIcon },
    ...
    const socialIcons = [
        { icon: FacebookIcon, link: "https://www.facebook.com/loveabledealsbd/" },
        { icon: InstagramIcon, link: "https://www.instagram.com/loveabledealsbd" },
        { icon: TiktokIcon, link: "https://www.tiktok.com/@loveable.deals.bd" },
    ]
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/">
                            <Image src={assets.logo} alt="Loveable Deals BD logo" width={160} height={44} className="w-36 object-contain mb-2" />
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to Loveable Deals BD, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place&#44; Inshallah.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © Loveable Deals BD All Right Reserved.
                </p>
            </div>
        </footer>
    );
